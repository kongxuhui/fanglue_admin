<template>
    <div class="main">
        ...
        <el-table :data="userList" stripe border>
            ...
            <el-table-column prop="corpNameShort" label="企业简称"></el-table-column>
            <el-table-column prop="bizlicenseNum" label="营业执照编号"></el-table-column>
            <el-table-column prop="legalRepresentative" label="法定代表人"></el-table-column>
            <el-table-column label="营业执照图片">
                <template slot-scope="scope">
                    <img :src="scope.row.bizlicenseImg" class="img" alt="" style="width:100px">
                </template>
            </el-table-column>
