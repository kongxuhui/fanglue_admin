<template>
    <div class="main">
        ...
        <el-table :data="userList" stripe border @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="type" label="身份证有效期"></el-table-column>
            <el-table-column prop="time" label="认证状态"></el-table-column>
            ...
            <el-table-column label="操作" width="100">
                <template slot-scope="scope">
                    ...
                    <div class="mt10"><el-button size="mini" type="success" @click="handleState(scope.row, 'stop')">通过</el-button></div>
